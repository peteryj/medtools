...
<html lang="en">
    ...
    <body class="page-container-bg-solid">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    <div class="container">
                        ...
                        <p></p>
                        <textarea class="form-control" style="resize:none" id="txPapers" name="papers" rows="3" cols="100" ></textarea>
                        <br />
                        <input id="btnQuery" type="submit" value="查询引用数" />
                        </form>
                        {{if .Result}}
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="portlet light ">
                                        ...
                                        <table id="dtResult" class="table table-striped table-bordered table-hover" >
                                        <thead>
                                        <tr>
                                        <th>论文标题</th>
                                        <th>引用数(-1表示找不到论文)</th>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6 col-xs-12 footer-block">
                        <h2>关于</h2>
                        <p> 文献助手是基于微软学术搜索API开发的小工具，功能还在不断迭代中，欢迎提出任何建议～ </p>
                    </div>
                    <div class="col-md-3 col-sm-6 col-xs-12 footer-block">
                        <h2>联系方式</h2>
                            <br> Email:
        ...
        <div class="page-footer">
            <div class="container"> 2017 &copy; peteryj
            </div>
        </div>
